...
class mywindow(QtWidgets.QMainWindow):
    ...
    def btnClicked(self):
        ...
        self.ui.lineEdit_3.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.ui.lineEdit_4.clear()
        self.ui.lineEdit_4.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        with open("100IRverbs.csv", encoding='utf-8') as file:
    ...
    def btnClicked_2(self):
        ...
        YourVersion = [self.ui.lineEdit, self.ui.lineEdit_2, self.ui.lineEdit_3, self.ui.lineEdit_4]
        TrueVersion = [self.ui.lineEdit_5, self.ui.lineEdit_6, self.ui.lineEdit_7, self.ui.lineEdit_8]

        for i, j in zip(YourVersion, TrueVersion):
            if i.text() != j.text():
